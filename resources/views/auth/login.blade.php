    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="{{ asset('assets/login/assets/images/login1.jpg') }}" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <!-- <img src="{{ asset('assets/login/assets/images/logo.svg') }}" alt="logo" class="logo"> -->
              </div>
